"""
Production settings for Mentara deployment.
...
if USE_CLOUDINARY:
    ...
    # Storage backend typically returns absolute URLs; keep MEDIA_URL defined for compatibility.
    MEDIA_URL = '/media/'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/mentara/error.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
